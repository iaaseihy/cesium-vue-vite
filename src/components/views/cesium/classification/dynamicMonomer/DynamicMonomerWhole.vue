      ...
      <div class="building-collect-whole">
        <div>
          <el-button :title="tip_1" size="mini" @click="startDraw()"
            >整幢采集</el-button
          >
          <el-button :title="tip_2" size="mini" @click="submit()"
            >确认</el-button
          >
          <el-button :title="tip_3" size="mini" @click="exportJson()"
            >导出</el-button
          >
        </div>
...
<script>
// import ClassifyJson from "@public/static/json/default.json";
import ClassifyJson from "./default (2).json"
