 ...
 * @LastEditTime: 2023-08-30 17:47:08
 * @FilePath: \demo\src\js\mapjs\entityOperation.js
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */

import waternormolsIMG from '../../../../../../public/static/texture/waterNormals.jpg'
import * as Cesium from 'cesium';

export function createGroudRegon(positions, color) {
...
export function createDynamincWater(positions, height) {
  //河道关键点数组
  //河道1多边形
...
export function createGLTFModel(modelURL, position, scalexyz) {
...
export function creatGateNumNote(param) {
...
export function addLineGround(param) {
  var entity = new Cesium.Entity({
    name: param.name,
    wall: {
...
export function createUpDownNote(param) {
  var entity = new Cesium.Entity({
    name: param.text,
    position: Cesium.Cartesian3.fromDegrees(param.position[0], param.position[1], param.position[2]),
...
export function createDuanMianNote(param, viewer) {
  /**
...
export function createBillboardEntity(param,viewer) {
