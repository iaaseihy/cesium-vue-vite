 ...
 * @LastEditTime: 2023-04-11 14:45:24
 */
...
class SlopeEffect {
  ...
  init() {
    // 移动
    var _self = this; var _that = _self._that; var info = ''
    _that.handler.setInputAction(function (movement) {
      const cartesian = _that.mouseManager.piTerrainToModule(movement.endPosition)
    ...
    _that.handler.setInputAction(function (movement) {
      ...
      const cartesian = _that.mouseManager.piTerrainToModule(movement.position)
