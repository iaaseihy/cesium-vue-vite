 ...
 * @LastEditTime: 2023-04-07 16:49:13
 */
/**
 * entitys 实体类
 * 管理实体模型
...
export default class Entitys {
  ...
  // 圆
  getEllipse(opt) {
    const r = opt.r === undefined ? 1000000.0 : opt.r
  ...
  // 球
  getEllipsoid(opt) {
    const r = opt.r === undefined ? 1000000.0 : opt.r // 默认100公里
  ...
  createPoint(cartesian, label = false, point = false, billboard = false) {
    ...
    const entityPoint = this.add(entity)
    return entityPoint
  }
