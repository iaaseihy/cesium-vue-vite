...
function dpper(satrec, options) {
  ...
  var mp = options.mp // Copy satellite attributes into local variables for convenience
...
function dsinit(options) {
  ...
  var argpo = options.argpo
  var s1 = options.s1
  var s2 = options.s2
  var s3 = options.s3
  var s4 = options.s4
  var s5 = options.s5
  var sinim = options.sinim
  var ss1 = options.ss1
  var ss2 = options.ss2
  var ss3 = options.ss3
  var ss4 = options.ss4
  ...
  var sz1 = options.sz1
  var sz3 = options.sz3
  var sz11 = options.sz11
  var sz13 = options.sz13
  var sz21 = options.sz21
  var sz23 = options.sz23
  var sz31 = options.sz31
  var sz33 = options.sz33
  var t = options.t
  var tc = options.tc
  var gsto = options.gsto
  var mo = options.mo
  var mdot = options.mdot
  var no = options.no
  var nodeo = options.nodeo
  var nodedot = options.nodedot
  var xpidot = options.xpidot
  var z1 = options.z1
  var z3 = options.z3
  var z11 = options.z11
  var z13 = options.z13
...
function sgp4init(satrec, options) {
  /* eslint-disable no-param-reassign */
  var opsmode = options.opsmode
  var satn = options.satn
  var epoch = options.epoch
  var xbstar = options.xbstar
  var xecco = options.xecco
  var xargpo = options.xargpo
  var xinclo = options.xinclo
  var xmo = options.xmo
  var xno = options.xno
  var xnodeo = options.xnodeo
  var cosim
  var sinim
  var cc1sq
  var cc2
...
function topocentric(observerGeodetic, satelliteEcf) {
  ...
  var latitude = observerGeodetic.latitude
