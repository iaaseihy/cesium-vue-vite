...
import Camera from '../commonTool/camera.js'; var eText = [
  {
    text: '显示此处经纬度',
    type: 'longlat'
  },
...
export default class RightMenu {
  constructor(opt) {
    ...
    const $this = this
    const menu = new HTML().loadCSS(config.CODEDIR + '/BaseUI/css/menu.css')
