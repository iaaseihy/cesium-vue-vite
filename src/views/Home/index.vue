  ...
  methods: {
      ...
      scene.on('loaded', () => {
        ...
        pointLayer.on('mousemove', (e) => {
          ...
          this.pointTimer = setTimeout(() => {
            const iotPercentage =
              (e.feature.iotDoorControlCount / cityData.data.iotdoorControlCount).toFixed(2) > 0.001 ? (e.feature.iotDoorControlCount / cityData.data.iotdoorControlCount).toFixed(2) : 0.001
            ...
            const ringData = [
              {
                ...
                percentageData: [
                  ...
                  { color: 'rgba(183, 226, 255, 0.3)', value: 1 - openPercentage }
                ]
              },
              {
                id: 'iot',
                ...
                percentageData: [
                  ...
                  { color: 'rgba(183, 226, 255, 0.3)', value: 1 - iotPercentage }
                ]
              },
              {
                id: 'community',
                ...
                percentageData: [
                  ...
                  { color: 'rgba(183, 226, 255, 0.3)', value: 1 - communityPercentage }
                ]
              }
            ]
            this.bubbleData = {
    ...
    setElementHeight() {
      ...
      this.timer = setTimeout(() => {
        ...
        console.log(this.$refs.sectionRef.offsetHeight);
        // this.height = `${(sectionRef.offsetHeight === null ? 1215 : sectionRef.offsetHeight  - 30) / 3}px`
        this.height = `${(this.$refs.sectionRef && this.$refs.sectionRef.offsetHeight - 30) / 3}px`
      }, 100)
    },
    // 设置文字滚动
